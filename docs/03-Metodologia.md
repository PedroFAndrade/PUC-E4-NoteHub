...
- `Scrum Master` - Pedro Andrade
- `Product Owner` - Marcos Teixeira Dias
- `Dev Team` - Wesley, Bruno, Pedro, Marcos, Gustavo, Renan, Thalita
...
- `Editor de código`: Visual Code Studio, Expo
...
- `Ferramentas de desenho de Digrama`: LucidChart, dbdiagram.io

Os editores de códigos foram escolhidos porque eles possuem uma integração com o
